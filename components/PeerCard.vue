<template>
  <div class="flex py-2 text-white drop-shadow-lg rounded-lg bg-teal-700 hover:bg-teal-600 cursor-pointer">
    ...
    <div class="flex-1">
      ...
      <p class="text-xs mt-1 mb-1">
        <span class="bg-teal-900 px-1 py-0.5 rounded">{{ props.peer.deviceModel ?? 'Unknown' }}</span>
